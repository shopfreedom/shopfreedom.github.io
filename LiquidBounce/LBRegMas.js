descriptionCheatsArr = [
	...
	'ChestAura — автоматическое открытие сундуков в определенном радиусе.',
	...
	'Luquids — отключение\\включение ликвида.',
	...
	'NoRotatetSet — функция блокирует возможность разворота.',
	'ResoursePackSpoof — подделка пакета ресурсов.',
	...
	'Zool — простая функция, которая убирает негативные эффекты.',
	...
	'BugUp — во время прыжка софт сообщает о том, сколько блоков осталось до падения.',
	...
	'NoClip — режим полёта\\бессмертия\\прохождения сквозь стены.',
	...
	'Parkour — дает пользователю значительное преимущество по сравнению с другими игроками и облегчает прохождение игры.',
	...
	'Strafe — обстреливание всё вокруг.',
	'WallClimb — хождение по стенам на сервере.',
	'WatterSpeed — быстрое хождение по воде.',
	'AntiBlind — при возможности функция позволяет убрать эффекты слепоты и тошноты.',
	'BlockESP — у последних измененных блоков на время появляется обводка.',
	...
	'NoSwing — предотвращение анимации качания для других игроков.',
	'Projectiles — указание траектории полета стрел, снежков, яиц.',
	'ProphunESP — в мини-игре HideAndSeek через стены показывает фэйковые блоки.',
	'Rotations — допустимость выставления направления взгляда.',
	...
	'Tracers — обнаружение/подсвечивание только лишь ближайших от персонажа игроков.',
	...
	'BedGodModer — при нажатии на кровать персонаж может лечь в другом месте.',
	...
	'Damage — работа чита на дамаг основана на уменьшении показателя глобального кулдауна, тем самым повышается ДПС персонажа.',
	...
	'AutoBow — автоматическое нацеливание или стрельба из лука.',
	'AutoClicker — автоматическое нанесение ударов по установленному количеству CPS персонажем или создателем софта.',
